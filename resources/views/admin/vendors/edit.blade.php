                    ...
                    <form method="post" action="{{route('admin.vendors.update' , $vendor -> id)}}" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <label for="exampleInputFile">Vendor Logo</label>
                                <div class="text-center">
                                    <img src="{{$vendor -> logo}}" alt="Category Photo" class="rounded-circle " style="height: 100px; width: 100px;">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputFile"> Vendor Logo</label>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="" name="name" value="{{$vendor -> name}}">
                                        @error('name')
                                        <span class="text-danger">{{$message}}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select name="category_id" class="form-control">
                                            <optgroup label="Please Choose Category Name">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Email </label>
                                        <input type="text" class="form-control" placeholder="" name="email" value="{{$vendor -> email}}">
                                        @error('email')
                                        <span class="text-danger">{{$message}}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Mobile</label>
                                        <input type="text" class="form-control" placeholder=""  name="mobile" value="{{$vendor -> mobile}}">
                                        @error('mobile')
                                        <span class="text-danger">{{$message}}</span>
                                        @enderror
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" id="exampleCheck1"  name="active" @if($vendor-> active == 1) checked @endif >
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="" value="{{$vendor->address}}" name="address" id="pac-input" >
                                        @error('address')
                                        <span class="text-danger">{{$message}}</span>
                                        @enderror
                                    </div>
